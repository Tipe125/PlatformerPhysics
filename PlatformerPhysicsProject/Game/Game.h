...
public:
	...
	//bool CheckForCollision(Vector3 object1pos, Vector3 object2pos);
...
protected:
	...
	list<GameObject*> m_collidables; //objects with collision logic
	...
	bool CheckCollision(Vector3 object1Pos, Vector3 object2Pos);
	void CollisionResolution(GameObject* object1, GameObject* object2);
};
